...
class Select extends Query
{
  ...
  /** Sets the columns to group the results by. @param array $columns An array of column names to group by. @return Select Returns the current Select instance for method chaining./
  ...
  /** Adds an ORDER BY clause to the SQL query. @param string $column The column name to order by. @param string $direction The direction of the order, either 'ASC' or 'DESC'. Defaults to 'ASC'. @return Select Returns the current Select instance for method chaining./
  ...
  /** Sets the offset for the SQL query. @param int|string $offset The offset value to set. @return Select Returns the current Select instance./
  ...
  /** Sets the limit for the number of rows to retrieve. @param int|string $limit The maximum number of rows to retrieve. If a string is provided, it must be numeric. @return Select Returns the current Select instance. @throws \InvalidArgumentException If the provided limit is a non-numeric string./
