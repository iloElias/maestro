...
class UpdateTest extends TestCase
{
  public function testUpdate()
  {
    ...
    $expectedSql = "UPDATE {$table::getTableName()} SET nickname = :nickname WHERE email = :where_email";
  ...
  public function testUpdateWithInClause()
  {
    ...
    $expectedSql = "UPDATE {$table::getTableName()} SET nickname = :nickname WHERE id IN(:in_id_0,:in_id_1,:in_id_2)";
  ...
  public function testUpdateWithMultipleConditions()
  {
    ...
    $expectedSql = "UPDATE {$table::getTableName()} SET nickname = :nickname WHERE email = :where_email AND active = :where_active";
  ...
  public function testMultipleInConditions()
  {
    ...
    $expectedSql = "UPDATE {$table::getTableName()} SET nickname = :nickname WHERE id IN(:in_id_0,:in_id_1,:in_id_2) AND group_id IN(:in_group_id_0,:in_group_id_1,:in_group_id_2)";
    $expectedParams = [
  ...
  public function testUpdateWithoutConditions()
  {
    ...
    $expectedSql = "UPDATE {$table::getTableName()} SET nickname = :nickname";
  ...
  public function testUpdateWithTimestamp()
  {
    ...
    $expectedSql = "UPDATE {$table::getTableName()} SET updated_at = :updated_at WHERE email = :where_email";
  ...
  public function testUpdateMultipleSetClauses()
  {
    ...
    $expectedSql = "UPDATE {$table::getTableName()} SET nickname = :nickname, active = :active WHERE email = :where_email";
